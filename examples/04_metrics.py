...
print(f"  precision: {prf['precision']:.2f}  (of those we flagged spam, how many were?)")
...
print(f"  pass@1 = {evals.pass_at_k(attempts, 1):.0%}   pass@3 = {evals.pass_at_k(attempts, 3):.0%}")
